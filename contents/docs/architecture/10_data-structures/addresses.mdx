...
*   **[Extended Addresses](./extended-addresses)** - How a standard address is extended with a payment flag and optional tag to express delivery intent (online handshake, offline delivery, or enhanced privacy).
