...
| :----------------- | :------- | :------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `to`               | `string` | Yes      | A hyphen-separated list of `address_amount` pairs. The address can be a standard Ixian address or an [Extended Address](../../../architecture/10_data-structures/extended-addresses). See **Custom Formats** below.                                                                                        |
...
*   Each entry is an `address` (which can be a standard address or an Extended Address) and an `amount` separated by an underscore (`_`).
