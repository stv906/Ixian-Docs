...
| `extendedAddresses`  | `string` | Yes      | A base58-encoded extended address associated with the transaction. |
| `requestId`          | `string` | No       | Optional request identifier for tracking the transaction.      |
