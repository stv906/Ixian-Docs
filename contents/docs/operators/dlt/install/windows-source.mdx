...
## Prerequisites
* Visual Studio 2026 (Community Edition is fine), with the following modules:
...
The source for Ixian DLT may be downloaded from the [Ixian Github page](https://github.com/ixian-platform). There are several options available:
...
![Ixian Project Placement](/assets/images/guide_win_building_dlt_1.png)
...
![Rebuild Solution](/assets/images/guide_win_building_dlt_2.png)
...
![Solution Configuration](/assets/images/guide_win_building_dlt_6.png)
...
![Output Window](/assets/images/guide_win_building_dlt_3.png)
...
![Build Results](/assets/images/guide_win_building_dlt_4.png)
...
![EXE File](/assets/images/guide_win_building_dlt_5.png)
