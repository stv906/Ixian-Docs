...
* Install the dotnet 10.0 SDK following the guide here: [DotNet Installation Guide](https://learn.microsoft.com/en-us/dotnet/core/install/windows#net-installer).
