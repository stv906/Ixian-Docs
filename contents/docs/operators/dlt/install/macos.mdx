...
1. Install dotnet SDK for macOS from here: [dotnet10.0 download](https://dotnet.microsoft.com/en-us/download/dotnet/10.0).
...
```
cp libargon2.1.dylib ~/Ixian/Ixian-DLT/IxianDLT/bin/Release/net10.0/libargon2.dylib
```
