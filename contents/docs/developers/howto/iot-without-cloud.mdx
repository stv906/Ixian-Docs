...
**Privacy by default** - End-to-end encrypted (AES-256-GCM + ChaCha20-Poly1305)  
...
# For local Regtest (Docker), use: addTestnetPeer = 10.24.231.1:10234
...
**Security:** Post-quantum encrypted end-to-end (AES-256 + ChaCha20-Poly1305)  
**Cost:** $0  
...
| Data encryption | AES-256 | AES-256-GCM + ChaCha20-Poly1305 (layered) |
